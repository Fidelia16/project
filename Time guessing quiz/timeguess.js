...
stop.addEventListener("click",
  function () {
    ...
    if (elapsed >= 10000 && elapsed < 11000) { // 10秒〜10.1秒の間だけ1回鳴る
      soundControl("start", "sound/stop2.mp3");
      // soundControl("end", "");
      document.body.classList.toggle("firework-bg");
...
reset.addEventListener("click",
  function () {
    ...
    stopTime = 0;
    document.body.classList.toggle("firework-bg",false);
    document.body.classList.toggle("default-bg",true);
  }
);
...
function countUp() {
  ...
  timeoutid = setTimeout(() => {
    // 再帰呼び出し
    //   if (elapsed >= 10000 && elapsed < 10100) { // 10秒〜10.1秒の間だけ1回鳴る
    //     if (soundEndflag === "1") {
    //       soundControl("end", "");
    //       document.body.classList.toggle("firework-bg");
    // document.body.classList.toggle("default-bg");
